  ...
  <div class="relative isolate overflow-hidden bg-white">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 flex lg:px-8 lg:py-20 justify-center">
      <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
        ...
        <h1 class="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Deploy to the cloud with confidence
        </h1>
        ...
        <div>
          ...
          <div class="hidden sm:block">
            <nav class="flex space-x-4" aria-label="Tabs">
              <a v-for="(tab, index) in tabs" :key="index" @click.prevent="selectedTab = index"
                :class="[selectedTab === index ? 'bg-gray-100 text-gray-700' : 'text-gray-500 hover:text-gray-700', 'rounded-md px-3 py-2 text-sm font-medium']"
                href="#">{{ tab.name }}</a>
            </nav>
          </div>
        </div>
        ...
        <div class="mt-4">
          <div v-if="selectedTab === 0" >
            ...
            <p>2. Promotions, welcoming messages, updates, invitations, recommendations, or requests to complete a new
            transaction</p><br>
            <p>3. Require template approval and customer opt-in</p>
            <img src="\images\img1.png" width="350" height="350" class="flex items-center"></div>
